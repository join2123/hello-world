...
////////变量说明////////
//led定义
sbit L1=P2^0;//////定义第1个指示灯的名称为L1  还可以直接采用P0_0;因为AT89X51.H内部已做定义,下依次类推
sbit L2=P2^1;//////定义第2个指示灯的名称为L2 
sbit L3=P2^2;//////定义第3个指示灯的名称为L3  
sbit L4=P2^3;//////定义第4个指示灯的名称为L4 
sbit L5=P2^4;//////定义第5个指示灯的名称为L5  
sbit L6=P2^5;//////定义第6个指示灯的名称为L6 
sbit L7=P2^6;//////定义第7个指示灯的名称为L7  
sbit L8=P2^7;//////定义第8个指示灯的名称为L8 
//按键定义
sbit key_1=P3^1;//////定义第1个按键为KEY_1
sbit key_2=P3^0;//////定义第1个按键为KEY_2
sbit key_3=P3^2;//////定义第1个按键为KEY_3
sbit key_4=P3^3;//////定义第1个按键为KEY_4
//锁存器定义
sbit duan_clc=P2^6;//////定义段锁存器(IC7)时钟脉冲
sbit wen_clc=P2^7;//////定义位锁存器(IC6)时钟脉冲
//蜂鸣器定义
sbit FMQ=P1^5;//////定义fmq蜂鸣器单片机驱动口
/////////////////////////////
...
//////////////闹铃时间设置//////////////
unsigned char jsq_naoling_1hours,jsq_naoling_1min,jsq_naoling_1s;///////闹铃时间
...
////////////////利用中断实验时间与数码管的关系,其中采用中断函数计数//////////////////////////////////////
		...
		//if(jsq_naoling_1hours==jsq_1hours&&jsq_naoling_1min==jsq_1min){TR1=1;}
        } 
...
///////////1键多功能/////////////////////////
	if(key_1==0)/////////如果按键按下
	{
	  ...
	  if(key_1==0)///////按键的确按下
		...
		while(key_1==0){display_seg_HC6800();}///////按键等待抬起
		}
	}
	...
	if(jsq_function==1)
	{
		if(key_2==0)/////////如果按键按下
		{
		  ...
		  if(key_2==0)///////按键的确按下
			...
			while(key_2==0){display_seg_HC6800();}///////按键等待抬起
			}
		}
		if(key_3==0)/////////如果按键按下
		{
		  ...
		  if(key_3==0)///////按键的确按下
			...
			while(key_3==0){display_seg_HC6800();}///////按键等待抬起
			}
		}
	}
///////////功能2/////////////////////////
...
///////////功能结束开表运行/////////////////////////
	...
	if(key_4==0)/////////如果按键按下
	{
	  ...
	  if(key_4==0)///////按键的确按下
		...
		while(key_4==0){display_seg_HC6800();}///////按键等待抬起
		}
	}
